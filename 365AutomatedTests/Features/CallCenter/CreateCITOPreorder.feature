Feature: CreateCITOPreorder
This autotest created simple preorder with CITO contract

@mytag
Scenario: CreateCITOPreorderWithCITOOption
	...
	When I choose "13713" diagnostic center
